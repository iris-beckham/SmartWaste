    ...
    <div className="min-h-screen mb-0">
      <div className="grid grid-cols-1 md:grid-cols-5 ">
        ...
        <div className="col-span-1 md:col-span-2 bg-white">
          <div className="bg-black m-5 rounded-xl max-h-3/4 ">
            ...
            <div className="flex">
              ...
              <div className="text-center text-white ml-auto mr-5 text-lg font-bold py-3">
                <div>{filteredSites.length} Locations</div>
              </div>
              ...
              <div className="flex justify-end mr-10 mb-2">
                <form action="" onSubmit={handleSubmit}>
                  ...
                  <select
                    name="borough"
                    value={borough}
                    onChange={handleBoroughFilterChange}
                  >
            ...
            <div className="overflow-y-auto h-120 grid gap-4">
              {filteredSites.map((site) => {
                ...
                return (
                  <div
                    key={site_location + mgp_bins + paper_bins + site_type}
                    className="bg-blue-300 mx-5 rounded-lg px-5 py-7 hover:scale-105 transition-transform duration-300"
                  >
                    {partner === "N/A" ? (
                      ""
                    ) : (
                      <p>{capitalizeFirstLetters(partner)}</p>
                    )}
