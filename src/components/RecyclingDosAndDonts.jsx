  ...
  return (
    <>
      <div className=" col-span-1 md:col-span-3">
        <div className="bg-blue-300 m-5 rounded-xl overflow-y-auto h-3/4">
            ...
            <div className="w-3/4">
              ...
              <div className="border-2 border-black rounded-lg">
                <ul className="list-disc px-5 py-1">
                  ...
                  <li>
                    Note: Beverage and liquid food cartons (like milk cartons
                    and juice boxes) should be recycled with metal, glass, and
                    plastic, NOT with paper.
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="p-5 grid grid-cols-2">
            <div className="w-3/4">
              ...
              <div className="border-2 border-black rounded-lg">
                <ul className="list-disc px-5 py-1">
                  ...
                  <li>
                    Can't: drinking glasses, eyeglasses, glass furniture,
                    mirrors, light bulbs
                  </li>
                </ul>
              </div>
            ...
            <div className="w-3/4">
              ...
              <div className="border-2 border-black rounded-lg p-2">
                You can recycle beverage and liquid food cartons like milk and
                soup cartons and juice boxes. These are lined with a plastic
                film to make them leak-proof, and the plastic layer can be
          ...
          <div className="border-2 border-black rounded-lg mx-20 my-5">
            <ul className="list-disc px-5 py-1">
              ...
              <li>
                Tanglers: Cables, wires, extension cords, string lights, garden
                hoses, window blinds
              </li>
